...
CONTRACT_DIR="/data/L1-deploy/contracts"
...
SPECIAL_ACCOUNTS=("bitcash" "prop.bitcash" "refe.bitcash" "fund.impact" "boid" "gaboesquivel" "sphere" "detroit") # accounts with large amounts of IMPACT tokens
